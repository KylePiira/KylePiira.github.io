...
function refreshMyTrades() {
	var myTradesURL = 'https://poloniex.com/private?command=returnUserTradeHistoryJSON&currencyPair=' + currencyPair;
...
function cancelOrder(orderNumber) {    
	...
	$.post("https://poloniex.com/private", params,function(data){
...
function cancelTriggerOrder(orderNumber) {
    url = "https://poloniex.com/private";
...
function updatePrivateInfo(){
	var url = 'https://poloniex.com/private?command=returnPrivateInfoJSON&currencyPair=' + currencyPair;
...
function executeCloseMarginPosition(currencyPair){
	hideConfirmDiv(true);
	showProgressBar();
	$.post("https://poloniex.com/private.php",{command: "closeMarginPosition",currencyPair: currencyPair}).done(function(data){
		$("#result").html(data);
		showAlert();
		updatePrivateInfo();
	});
