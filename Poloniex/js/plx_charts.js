...
function refreshCandleSticksFirst() {
	...
	$.get("https://poloniex.com/chartData/" + currencyPair + "-" + chartType + ".json").done(function(data){
		...
		var url = 'https://poloniex.com/public?command=returnChartData&currencyPair='+currencyPair+'&start=' + start + '&end=9999999999&period='+chartType;
...
function refreshCandleSticks() {
	...
	url = 'https://poloniex.com/public?command=returnChartData&currencyPair='+currencyPair+'&start='+candleStart+'&end=9999999999&period='+chartType;
