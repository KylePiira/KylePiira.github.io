$(document).ready(function() {
	...
	$("#criticalMessage .close a").click(function() {
	  ...
	  if (type=='liquidation'){
			$.get('https://poloniex.com/private.php?command=dismissLiquidationAlert').done(function(d) {
	...
	function checkNotifications(){
		$.getJSON('https://poloniex.com/private?command=checkNotifications',function(d) {
